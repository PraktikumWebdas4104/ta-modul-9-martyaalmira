...
foreach($db->edit($_GET['id']) as $d){ 
	...
	$array2 = explode(", ", $d['wisata']);//panggil method edit dari class database
?>
<table>
	<tr>
		<td>Nama</td>
	...
	<tr>
		<td>Wisata</td>
		<td>
		<input type="checkbox" name="wst[]" value="Bali" <?php if(in_array('Bali', $array2)){echo "checked=checked";} ?> >Bali <br>

		<input type="checkbox" name="wst[]" value="Raja Ampat" <?php if(in_array('Raja ampat', $array2)){echo "checked=checked";} ?> >Raja Ampat<br>

		<input type="checkbox" name="wst[]" value="Pulau Derawan" <?php if(in_array('Pulau Derawan', $array2)){echo "checked=checked";} ?> >Pulau Derawan<br>

		<input type="checkbox" name="wst[]" value="Bangka belitung" <?php if(in_array('Bangka belitung', $array2)){echo "checked=checked";} ?> >Bangka Belitung<br>

		<input type="checkbox" name="wst[]" value="Labuan bajo" <?php if(in_array('Labuan Bajo', $array2)){echo "checked=checked";} ?> >Labuan Bajo<br>
		</td>
	</tr>
	<tr>
		<td></td>
